...
# =============================================================================
# 2. SISTEM LOGIN AKSES (PASSWORD PROTECTED)
# =============================================================================
def check_password():
...
# Jalankan proteksi login sebelum memuat seluruh aplikasi
if check_password():

    # =============================================================================
    # 3. FUNGSI AMBIL DATA LIVE DARI GOOGLE SHEETS
    # =============================================================================
    ...
    def top_kata(seri_teks: pd.Series, n=40):
        ...
        kata_clean = [k for k in kata if k not in STOPWORDS_ID]
        return Counter(kata_clean).most_common(n)

    # =============================================================================
    # 5. FUNGSI KLASIFIKASI KUADRAN PERFORMA
    # =============================================================================
    ...
    try:
        ...
        # =============================================================================
        with tab_exec:
            st.markdown(f"### Performa Global & Validasi Kuadran Performa – Basis: **{model_terpilih}**")
            ...
            with col_a:
                st.subheader("Scatter Plot: Realisasi vs Prediksi (Berdasarkan Garis Median)")
                fig = px.scatter(
                    df,
                    x=col_pred,
                    y=col_actual,
        ...
        with tab_deep:
            ...
            with col_f2:
                filter_kuadran = st.selectbox(
                    "Saring Kuadran Performa:",
                    ["Semua Klaster", "Over-Predicted", "Under-Predicted", "On-Track", "Under-Performing"]
                )
        ...
        with tab_model:
            ...
            st.subheader("A. Analisis Sebaran 4 Kuadran Performa Cabang (Berbasis Median)")
            fig_km = px.scatter(
                df, 
                x=col_pred, 
                y=col_actual, 
